...
######### BRICK CONSTANTS #########
#: the color of bricks.
BRICK_COLORS1 = colormodel.RED
BRICK_COLORS2 = colormodel.ORANGE
BRICK_COLORS3 = colormodel.YELLOW
BRICK_COLORS4 = colormodel.GREEN
BRICK_COLORS5 = colormodel.CYAN
PADDLECOLOR = colormodel.BLACK

######## BRICK CONSTANTS #########
#the animation step of paddle move.
ANIMATION_STEP = 10

######### GAME CONSTANTS #########
#: state when the game end
STATE_COMPLETE    = 5
